    ...
    internal class FruitTreeMachine : BaseMachine<FruitTree>
    {
        ...
        *********/
        ...
        public override MachineState GetState()
        {
            ...
            return this.Machine.fruitObjectsOnTree.Count > 0
                ? MachineState.Done
        ...
        public override ITrackedStack GetOutput()
        {
            ...
            if (tree.struckByLightningCountdown.Value > 0)
                return new TrackedItem(new SObject("382", tree.fruitObjectsOnTree.Count), onReduced: _ => tree.fruitObjectsOnTree.Clear());

            // else => fruit
            return new TrackedItem(tree.fruitObjectsOnTree[^1], onReduced: item => tree.fruitObjectsOnTree.Remove(item));
        }
