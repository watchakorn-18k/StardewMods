...
namespace Pathoschild.Stardew.Automate.Framework.Machines.Objects
{
    ...
    internal class FurnaceMachine : GenericObjectMachine<SObject>
    {
        ...
        *********/
        ...
        private readonly IRecipe[] Recipes =
        {
            ...
            new Recipe(
                ...
                inputCount: 5,
                output: _ => new SObject(SObject.copperBar.ToString(), 1),
                minutes: 30
            ),
            ...
            new Recipe(
                ...
                inputCount: 5,
                output: _ => new SObject(SObject.ironBar.ToString(), 1),
                minutes: 120
            ),
            ...
            new Recipe(
                ...
                inputCount: 5,
                output: _ => new SObject(SObject.goldBar.ToString(), 1),
                minutes: 300
            ),
            ...
            new Recipe(
                ...
                inputCount: 5,
                output: _ => new SObject(SObject.iridiumBar.ToString(), 1),
                minutes: 480
            ),
        ...
        *********/
        ...
        {
            if (input.TryGetIngredient(p => p.Sample.QualifiedItemID == $"(O){SObject.coal}", 1, out IConsumable coal) && this.GenericPullRecipe(input, this.Recipes))
            {
                coal.Reduce();
