    ...
    internal class CaskMachine : GenericObjectMachine<Cask>
    {
        ...
        *********/
        ...
        public override bool SetInput(IStorage input)
        {
            ...
            foreach (ITrackedStack consumable in input.GetItems().Where(match => match.Type == ItemRegistry.type_object && (match.Sample as SObject)?.Quality < SObject.bestQuality))
            {
